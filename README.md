...
How It Works
The program shows a welcome message and the available menu.
The user types the name of the item they want to order.
If the item exists, the user is asked to enter the quantity.
The cost is added to the total bill.
The program asks if the user wants to order more items.
When finished, the final bill is displayed.
Code Used
menu = {
    'Pizza':40,
    'Burger':30,
